...
val cleanup_expression_concat'_spec : Cert_Codegen.specfx = {
  ...
  thms=["cleanup_expression_concat'_unit","cleanup_expression_concat'_cons","cleanup_expression_concat'_single"],
...
\<close>
setup \<open>Cert_Codegen.thms_to_funs [map_expression2_func_spec,map_expression2'_func_spec] "Autogen_Map_Expression" "map_expression.ML"\<close>
