...
proof -
  have hadamard: "(hadamard \<otimes>\<^sub>o id_cblinfun) o\<^sub>C\<^sub>L (hadamard \<otimes>\<^sub>o id_cblinfun) = id_cblinfun"
  ...
  show ?thesis
    by (simp add: distinct_qvars_split1 distinct_qvars_split2 cblinfun_compose_assoc[symmetric] assoc_op_lift_aux
        ...
        lift_cblinfun_comp[OF hadamard] lift_cblinfun_comp[OF unitaryD2] lift_cblinfun_comp[OF CNOT] lift_cblinfun_comp[OF isometryD])
qed
