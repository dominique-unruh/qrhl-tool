...
lemma joint_measure_aux:
  ...
  shows "\<forall>a b. \<lbrakk>qregister_chain \<lbrakk>#1\<rbrakk>\<^sub>q (q::(bit, qu) qregister), qregister_chain \<lbrakk>#1\<rbrakk>\<^sub>q r\<rbrakk>\<^sub>q \<equiv>\<qq> \<lbrakk>qregister_chain \<lbrakk>#2.\<rbrakk>\<^sub>q q, qregister_chain \<lbrakk>#2.\<rbrakk>\<^sub>q r\<rbrakk>\<^sub>q \<le> apply_qregister_space \<lbrakk>qregister_chain \<lbrakk>#1\<rbrakk>\<^sub>q q, qregister_chain \<lbrakk>#1\<rbrakk>\<^sub>q r\<rbrakk>\<^sub>q (selfbutterket (a, b::bit) *\<^sub>S \<top>) \<sqinter> apply_qregister_space \<lbrakk>qregister_chain \<lbrakk>#2.\<rbrakk>\<^sub>q q, qregister_chain \<lbrakk>#2.\<rbrakk>\<^sub>q r\<rbrakk>\<^sub>q (selfbutterket (a, b) *\<^sub>S \<top>) \<squnion> apply_qregister_space \<lbrakk>qregister_chain \<lbrakk>#1\<rbrakk>\<^sub>q q, qregister_chain \<lbrakk>#1\<rbrakk>\<^sub>q r\<rbrakk>\<^sub>q (- (selfbutterket (a, b) *\<^sub>S \<top>)) \<squnion> apply_qregister_space \<lbrakk>qregister_chain \<lbrakk>#2.\<rbrakk>\<^sub>q q, qregister_chain \<lbrakk>#2.\<rbrakk>\<^sub>q r\<rbrakk>\<^sub>q (- (selfbutterket (a, b) *\<^sub>S \<top>))"
