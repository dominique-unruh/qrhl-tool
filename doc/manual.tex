...
It is also possible to include individual Isabelle commands directly inside the \texttt{.qrhl} file using the ``\texttt{isabelle\_cmd}''\toolidx{isabelle_cmd} command.
For example:
\begin{center}
  \begin{lstlisting}
