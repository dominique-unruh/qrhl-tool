...
More specifically, \texttt{qrhl-tool} looks for \texttt{\textnormal{\textit{installation\_dir}}/qrhl-tool.conf},
\texttt{\textnormal{\textit{home\_directory}}/.qrhl-tool.conf}, and \texttt{\textnormal{\textit{current\_dir}}/qrhl-tool.conf}, in that order.
...
%
  ...
  {(\alpha\times\beta)\ \mathtt{ccsubspace}}
