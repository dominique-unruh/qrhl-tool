...
\TODOQ{Document changed byqrhl tactic}

\TODOQ{Prove stronger QrhlElim rule to match that tactic}

\TODOQ{byqrhl gets optional list of qvars}
...
\TODOQ{Added tactics: if / jointif}
