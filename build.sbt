...
lazy val createAutogeneratedMLDirectory = taskKey[Unit]("Create directory isabelly-thys/autogenerated")
managedResources in Compile := (managedResources in Compile).dependsOn(createAutogeneratedMLDirectory).value
createAutogeneratedMLDirectory := {
  val dir = baseDirectory.value / "isabelle-thys" / "autogenerated"
  dir.mkdir()
}
