...
object IsabelleConsts {
  ...
  val tensorOp = "Hilbert_Space_Tensor_Product.tensor_op"
  ...
  val apply_qregister = "Prog_Variables.qregister.apply_qregister"
  ...
  val cregister_chain = "Prog_Variables.cregister_chain"
  val qregister_pair = "Prog_Variables.qregister_pair"
  val qregister_chain = "Prog_Variables.qregister_chain"
  val qFst = "Prog_Variables.qFst"
  val qSnd = "Prog_Variables.qSnd"
  val cFst = "Prog_Variables.cFst"
  val cSnd = "Prog_Variables.cSnd"
